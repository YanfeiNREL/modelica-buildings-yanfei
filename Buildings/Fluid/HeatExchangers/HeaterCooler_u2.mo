...
model HeaterCooler_u2 "Heater or cooler with prescribed heat flow rate"
...
equation
  connect(preHea.port, vol.heatPort) annotation (Line(
      ...
      color={191,0,0}));
  connect(u, gain.u) annotation (Line(points={{-120,72},{-102,72},{-102,66},{
          -82,66}}, color={0,0,127}));
  connect(gain.y, preHea.Q_flow) annotation (Line(points={{-59,66},{-50,66},{
          -50,60},{-40,60}}, color={0,0,127}));
  connect(Q_flow, preHea.Q_flow) annotation (Line(points={{110,60},{74,60},{74,
          80},{-48,80},{-48,60},{-40,60}}, color={0,0,127}));
